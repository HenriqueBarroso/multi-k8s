...
kubectl set image deployments/client-deployment server=henriquebarroso/multi-client:$SHA
kubectl set image deployments/worker-deployment server=henriquebarroso/multi-worker:$SHA
